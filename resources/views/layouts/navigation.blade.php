<header class="bg-white border-b border-gray-200 shadow-sm">
    <div class="flex items-center justify-between px-6 py-4">
        ...
        <div class="flex items-center gap-4">
            <!-- Notifications -->
            <button type="button" class="relative p-2 text-gray-600 hover:text-gray-900 hover:bg-gray-100 rounded-lg transition-all">
            ...
            <div class="relative" x-data="{ open: false }">
                ...
                >
                    <div class="w-9 h-9 bg-gradient-to-br from-gray-800 to-black rounded-lg flex items-center justify-center">
